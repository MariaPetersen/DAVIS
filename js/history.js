(function () {
    ...
    for (var i = 0; i < devisArray.length; i++) {
        ...
        validite.innerHTML =
            "<strong>Valide jusqu’au :</strong> " + devis.validite;
        ...
        // Section Cession de droits
        var cession = document.createElement("section");
        cession.className = "cession-droits";

        var cessionTitle = document.createElement("h3");
        cessionTitle.textContent = "Cession de droits";
        cession.appendChild(cessionTitle);

        var duree = document.createElement("p");
        duree.innerHTML =
            "<strong>Durée :</strong> " +
            (devis.dureeDroits || "Non spécifiée");
        cession.appendChild(duree);

        var territoire = document.createElement("p");
        territoire.innerHTML =
            "<strong>Territoire :</strong> " +
            (devis.territoireDroits || "Non spécifié");
        cession.appendChild(territoire);

        var supports = document.createElement("p");
        supports.innerHTML =
            "<strong>Supports :</strong> " +
            (devis.supportsDroits || "Non spécifiés");
        cession.appendChild(supports);

        section.appendChild(cession);
